...
/**
 * This is the model base class for the table "tag_idea".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "TagIdea".
 *
 * Columns in table "tag_idea" available as properties of the model,
 * followed by relations of table "tag_idea" available as properties of the model.
 *
 * @property string $id
 ...
 */
abstract class BaseTagIdea extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'TagIdea|TagIdeas', $n);
	}
	...
	public function rules() {
		return array(
			array('tag_id, idea_id, added_by, added_time, revoked_by', 'required'),
			array('tag_id, idea_id, added_by, revoked_by', 'length', 'max'=>11),
			array('revoked_time', 'safe'),
			array('revoked_time', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, tag_id, idea_id, added_by, added_time, revoked_by, revoked_time', 'safe', 'on'=>'search'),
		);
	}
