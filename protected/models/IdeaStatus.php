...
Yii::import('application.models._base.BaseIdeaStatus');

class IdeaStatus extends BaseIdeaStatus
{
	...
	public function findAllTranslated(){
		if (Yii::app()->getLanguage() == 'en') return IdeaStatus::model()->findAll();
		else{
			$lang = Language::model()->findByAttributes(array("language_code"=>Yii::app()->getLanguage()));
			$criteria=new CDbCriteria();
			$criteria->condition = " `table` = 'idea_status' AND language_id=".$lang->id;
