...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model, 'user_click_id'); ?>
		<?php echo $form->dropDownList($model, 'user_click_id', GxHtml::listDataEx(User::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
