    ...
    <div  class="row">
      <div class="columns card-content"  >
        ...
        <div class="card-floater">
          <a class="tiny button success radius" style="margin-bottom:0;" href="<?php echo Yii::app()->createUrl("person/".$user['id']); ?>" target="_blank"><?php echo Yii::t('app','details').' <span class="icon-angle-right"></span>'; ?></a>
        </div>
		  </div>
	  </div>
