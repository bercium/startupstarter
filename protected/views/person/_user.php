<div class="columns radius card-person">
    <?php $days = timeDifference($user['lastvisit_at'], date('Y-m-d H:i:s'), "days_total"); 
     if ($days < 6){ ?>
      <img src="images/act-high.png" style="position: absolute; top:-2px; left:-2px;" title="<?php echo Yii::t('app','High activity'); ?>" data-tooltip>
    <?php }else if ($days < 10){ ?>
      <img src="images/act-med.png" style="position: absolute; top:-2px; left:-2px;" title="<?php echo Yii::t('app','Medium activity'); ?>" data-tooltip>
    <?php }else{ ?>
      <img src="images/act-low.png" style="position: absolute; top:-2px; left:-2px;" title="<?php echo Yii::t('app','Low activity'); ?>" data-tooltip>
    <?php } ?>
