  ...
  <ul class="small-block-grid-1 large-block-grid-3">
	...
	<div class="pagination-centered">
		<ul class="pagination hide-for-small">
			<?php if ($page > 1){ ?>
			<li class="arrow"><a href="#" onclick="recentUsersPage('<?php echo Yii::app()->createUrl("idea/recent/".$page-1); ?>'); return false;">&laquo;</a></li>
			<?php } ?>
			
			<?php if ($page < $maxPage){ ?>
			<li class="arrow"><a href="#" onclick="recentUsersPage('<?php echo Yii::app()->createUrl("idea/recent/".$page+1); ?>'); return false;">&raquo;</a></li>
			<?php } ?>
