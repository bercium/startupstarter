  ...
  <ul class="small-block-grid-1 large-block-grid-3">
	...
	<div class="pagination-centered">
		...
		<ul class="pagination hide-for-small">
			...
			<?php }else{ ?>
      <li class="arrow"><a class="button secondary small  disabled">&laquo;</a></li>
			<?php } ?>
      ...
      <li class="arrow"><a class="button secondary small  disabled">&laquo;</a></li>
		...
		<small class="show-for-small">&nbsp;&nbsp;&nbsp;<a href="<?php echo Yii::app()->createUrl("project/recent/1"); ?>"  class="button secondary large expand">show all</a></small>