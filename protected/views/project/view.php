...
<div class="row idea-details" style="margin-top:50px;">
  <div class="columns radius panel  wrapped-content">
  <div class="row">
  <div class="large-8 columns main" >
    ...
    <div class="large-12">
      ...
      <div class="large-12 columns">
        <h3><?php echo Yii::t('app','Languages'); ?>:</h3> 
  ...
  <div class="item">
    <h4><?php echo Yii::t('app', 'Available') ?>:</h4>
  <?php echo $candidate['available_name']; ?>
  </div>
  <?php } ?>
  <?php if ($candidate['city'] || $candidate['country']){ ?>
  <div class="item">
  <h4><?php echo Yii::t('app', 'Location') ?>:</h4><a href="">
...
<div class="item"><h4><?php echo Yii::t('app','Author'). ":</h4>"  ; ?>
