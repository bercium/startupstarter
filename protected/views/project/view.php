...
<div class="row idea-details" style="margin-top:50px;">
	<div class="columns radius panel card-idea">
		...
		<div class="large-12 small-12">
			...
			<div class="large-8 columns title-field" >
      ...
      <div class="large-4 columns" style="margin-top:20px;">
         ...
         <?php 
          ...
          if ($canEdit) { ?>
          <a class="button secondary tiny  radius right" href="<?php echo Yii::app()->createUrl("project/edit",array("id"=>$idea['id'])); ?>"><?php echo Yii::t('app', 'Edit project') ?> <span class="ico-awesome icon-wrench"></span></a>
          
          <small style="margin:6px 10px 0 0" class="right meta"><?php echo Yii::t('app','viewed {n} time|viewed {n} times',array($idea['num_of_clicks'])); ?></small>
      ...
      <div class="large-12 columns">
        ...
        <p>
          <span class="meta">
          <?php echo Yii::t('app','Last updated').": </span>".Yii::app()->dateFormatter->formatDateTime(strtotime($idea['date_updated']),"long",null); ?>
          ...
          <p class="">
            ...
            ?>
              ...
              <div class="meta-field">
               <p class="meta"><?php echo Yii::t('app','Author').":"  ; ?>
          <a href="<?php echo Yii::app()->createUrl("person/".$member['id']); ?>">
                  <img src="<?php echo avatar_image($member['avatar_link'],$member['id']); ?>" data-tooltip title="<?php echo $member['name']." ".$member['surname']; ?>" alt="<?php echo $member['name']." ".$member['surname']; ?>" class="card-avatar" />
                </a><br></p>
