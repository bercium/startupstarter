...
//             'enableClientValidation'=>true,
              ...
              <?php if(!$idea_id){
                        echo CHtml::submitButton(Yii::t("app","Add link"),
                        array('class'=>"button small success radius",
                            'onclick'=>'addLink(\''.Yii::app()->createUrl("project/sAddLink").'\');')
                        );
                    } else {
                        echo CHtml::submitButton(Yii::t("app","Add link"),
                        array('class'=>"button small success radius",
      ...
      <div class="linkList">
        <?php if(isset($links) && is_array($links)){ foreach ($links as $url => $title){ ?>
        <div data-alert class="alert-box radius secondary" id="link_div_<?php echo $url; ?>">
          ...
          <a href="#" class="close" onclick="removeLink('<?php echo $url; ?>','<?php if($idea_id){echo Yii::app()->createUrl("project/deleteLink/".$idea_id);}else{echo Yii::app()->createUrl("project/sDeleteLink");} ?>')">&times;</a>
        </div>
        <?php }} ?>
      </div>