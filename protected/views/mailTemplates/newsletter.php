...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <a href="http://www.cofinder.eu/">
      <img src="<?php echo Yii::app()->getBaseUrl(true); ?>/images/logo-title.png" alt="cofinder" title="cofinder" style="border: 0;height: auto;line-height: 100%;outline: none;text-decoration: none;display: inline;margin: 0;padding: 0;" border="0" height="42" width="216">
    </a>
    </td>
  </tr>
    ...
    <td align="left" valign="top" bgcolor="#89b561" style="background-color:#89b561;">
      ...
      <tr style="background-color:#89b561; border:0;">
        <td align="center" valign="top" bgcolor="#89b561" style="color:#ffffff; font-family:Helvetica,Arial,sans-serif; font-size:11px; text-align: center;">
          ...
          This e-mail was sent from <a href="http://www.cofinder.eu"><strong>cofinder<strong></a> page.
