                                            	...
                                            	<table style="border-bottom: 3px solid #ddd;" id="logoLinks" border="0" cellpadding="0" cellspacing="0" width="650">
                                                	<tbody>
                                                        <tr>
                                                            ...
                                                            <a href="<?php if (isset($tc)) echo mailLinkTracking($tc,"http://www.cofinder.eu/","cofinder-logo"); else echo "http://www.cofinder.eu/"; ?>" style="text-decoration: none;">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <td style="border-collapse: collapse;font-family: Helvetica, Arial;font-weight: 300;">
                                                        	<div style="color: #89B561;font-family: Helvetica, Arial;font-size: 14px;line-height: 100%;text-align: right;">
                                                            	 <p style="margin-top: 3px; margin-bottom: 0;  font-family: Helvetica, Arial;font-size: 14px;line-height: 130%;text-align: left;">This email was sent from <a style="color: #ffffff; text-decoration: none;" href="<?php if (isset($tc)) echo mailLinkTracking($tc,"http://www.cofinder.eu/","cofinder-logo-bottom"); else echo "http://www.cofinder.eu/";?>">www.cofinder.eu</a>  </p>
   														    </div>
                                                        </td>
                                                        <td>
																<p style="text-align:right;" >
										                          <a href="<?php if (isset($tc)) echo mailLinkTracking($tc,"https://www.facebook.com/cofinder.eu","social-facebook"); else echo "https://www.facebook.com/cofinder.eu"; ?>"><img src="<?php echo Yii::app()->getBaseUrl(true); ?>/images/bottom-facebook.png"></a>
										                          <a href="<?php if (isset($tc)) echo mailLinkTracking($tc,"https://www.linkedin.com/company/cofinder","social-linkedin"); else echo "https://www.linkedin.com/company/cofinder"; ?>"><img src="<?php echo Yii::app()->getBaseUrl(true); ?>/images/bottom-linkedin.png"></a> 
										                          <a href="<?php if (isset($tc)) echo mailLinkTracking($tc,"https://plus.google.com/+CofinderEu/posts","social-gplus"); else echo "https://plus.google.com/+CofinderEu/posts"; ?>"><img src="<?php echo Yii::app()->getBaseUrl(true); ?>/images/bottom-gplus.png"></a> 
										                        </p>
                                                        </td>
                                                        <td colspan="2" style="border-collapse: collapse;font-family: Helvetica, Arial;font-weight: 300;"><img src="<?php echo Yii::app()->getBaseUrl(true); ?>/images/newsletter/divider.png" style="border: 0;height: 10px; line-height: 100%;outline: none;text-decoration: none;display: inline;margin: 0;padding: 0;" height="10" width="100%"></td>
                                                    </tr>
                                	...
                                	<table id="newsletterFooter" style="background-color: transparent;" border="0" cellpadding="10" cellspacing="0" width="650">
                                    	<tbody>
                                        	...
                                        	<td  bgcolor="#ddd" class="footerContent" style="border-collapse: collapse;font-family: Helvetica, Arial;font-weight: 300;padding: 0px 0;" valign="top">
                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="padding:0px 0;">
                                                    <tbody>
                                                        ...
                                                        <td style="border-collapse: collapse;font-family: Helvetica, Arial;font-weight: 300;">
                                                            ...
                                                            <center>                                                            
                                                                <p class="links">
																		<a style="color: #333; text-decoration: none;" href="<?php if (isset($tc)) echo mailLinkTracking($tc,"http://www.cofinder.eu/site/terms","terms"); else echo "http://www.cofinder.eu/site/terms"; ?>">Terms</a> |
																		<a style="color: #333; text-decoration: none;" href="<?php if (isset($tc)) echo mailLinkTracking($tc,"http://www.cofinder.eu/site/terms#privacy","privacy"); else echo "http://www.cofinder.eu/site/terms#privacy"; ?>">Privacy</a>
                                              ...
                                              if (isset($tc)) echo mailLinkTracking($tc,$link,"unsubscribe"); else echo $link; 
                                              ?>">Unsubscribe</a>
															              <?php } ?>
																</p>                                                                   
                                                        	</center>
