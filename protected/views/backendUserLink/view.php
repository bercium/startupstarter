...
array(
			'name' => 'link',
			'type' => 'raw',
			'value' => $model->link !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->link)), array('backendLink/view', 'id' => GxActiveRecord::extractPkValue($model->link, true))) : null,
			),
	),
)); ?>
