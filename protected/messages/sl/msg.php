...
return array (
  'Cancel' => 'Prekliči',
  'Drop files here to upload' => 'Tu odloži datoteke za nalaganje',
  'Failed' => 'Ni uspelo',
  ...
  '{file} is too small, minimum file size is {minSizeLimit}.' => '{file} je premajhna, najmanjša velikost je {minSizeLimit}.',
  'Register here' => 'Registriraj se tu',
  'Registration for coFinder' => 'Registracija za coFinder',
  'Retype Password is incorrect.' => 'Ponovno vpisano geslo je nepravilno',
  ...
  'Selecting an avatar will make you more recognizable.' => 'Na podlagi profilne slike se boste z ostalimi uporabniki lažje prepoznali ko se srečate v živo'!!!!!!!!!!!!!!!!!!!!!!!!!! Moja verzija prevoda ni dejanski prevod angleške,
  ...
  'Success!' => 'Uspelo!',
  'Successfully removed translation!' => 'Uspešno odstranjen prevod!',
  ...
  'Thank you for your registration. Please {{login}}.' => 'Hvala za vašo registracijo. Prosimo prijavite se {{prijava}}.',
...
Are you sure?' => 'To dejanje bo izbrisalo vaš račun. Ali res to želite?',
  ...
  'To activate your account go to {activation_url}' => 'Za aktivacijo vašega računa pojdite na {activation_url}',
  'To deactivate your account change "Account status" to "Off" and click "Deactivate". You will then be loged out of the system.' => 'Za ukinitev vašega računa, spremenite "Status računa" na "Izključeno" in kliknite na "Deaktiviraj račun". Nato vas bo sistem odjavil.',
  ...
  'We are a group of enthusiasts on a mission to help anyone with a great idea to assemble a successful startup team capable of creating a viable business. We are developing a web platform through which you will be able to share your ideas with the same-minded entrepreneurs and search for interesting projects to join.' => 'Smo ekipa katero združuje skupna želja po rešitvi problema na katerega smo naleteli na svojih poteh realizacije idej v realne produkte in storitve. Ustvarjamo spletno mesto, ki bo pomagalo vsem z dobrimi idejami najti člane ekipe, kateri bodo pomagali dobro idejo spremeniti v realnost. Oziroma omogočilo vsem, ki si želijo sodelovati pri ustvarjanju novih izdelkov in storitev, da najdejo idejo v katero verjamejo in se pridružijo ekipi ki jo uresničuje.',
  ...
  'We\'ve been hard at work on our new service called coFinder.
                                            ...
                                            <br /><br /> If we got your attention you can {activation_url}!' => 'Vztrajno delamo na razvoju nove storitve imenovane coFinder.
                                            Gre za spletno mesto na katerem boste lahko delili ideje s podobno mislečimi podjetniki ali pa poiskali zanimive projekte katerim se bi radi pridružili in jih pomagali uresničiti. 
                                            <br /><br /> {username} meni, da bi vas znalo zanimati testiranje beta verzije namenjene le omejenemu krogu ljudi.
                                            <br /><br /> Če je vabilo vzbudilo vaše zanimanje vas vabimo da se nam pridružite na {activation_url}!',
  ...
  'What is your prefered colaboration?' => 'Kakšen je vaš preferenčni način sodelovanja?',
  'What kind of colaboration do you prefer when working on a project?' => 'Kakšen način sodelovanja vam najbolj ustreza, ko delate na projektu?',
  ...
  'With the <span>right team</span> any <span>idea</span> can change your life' => 'Z <span>pravo ekipo</span> lahko katerakoli <span>ideja</span> spremeni vaše življenje',
...
You will have to be invited again to become a member.
Are you sure?' => 'Zapuščate projekt! V kolikor se mu boste želeli zopet pridružiti, boste potrebovali vabilo. Ste prepričani, da to želite?',
  'You are about to remove this member from the team!
Are you sure?' => 'Odstranili boste člana ekipe! Ste prepričani, da to želite?',
  'You are about to remove this open position!
Are you sure?' => 'Odstranili boste odprto pozicijo! Ste prepričani, da to želite?',
  'You are invited to join coFinder' => 'Vabimo vas, da se pridružite coFinder-ju',
  'You have requested the password recovery for {site_name}. To receive a new password, go to {activation_url}.' => 'Zahtevali ste pomoč pri obnovitvi gesla za {site_name}. Za novo geslo kliknite na {activation_url}.',
  'You may optionally enter a comparison operator (&lt;, &lt;=, &gt;, &gt;=, &lt;&gt; or =) at the beginning of each of your search values to specify how the comparison should be done.' => ''?????????????????,
  'You may optionally enter a comparison operator (<b>&lt;</b>, <b>&lt;=</b>, <b>&gt;</b>, <b>&gt;=</b>, <b>&lt;&gt;</b> or <b>=</b>) at the beginning of each of your search values to specify how the comparison should be done.' => ''???????????????? Ponovljena zgornja,
  ...
  '{username} welcome to coFinder!' => '{username} dobrodošli v coFinder-ju',
  0 => ''????????????????????,
  '
  ...
  '
      ...
      <br />Since the only constant in life are changes it is important not to fall asleep on past successes or to give up when first problem arises. Tomorrow is a new day, even at coFinder.' => '<br />Glede na to, da so v življenju edina konstanta spremembe je pomembno, da ne zaspimo na preteklih uspehih in da se ne obupamo ko se pojavijo prve težave. Jutri je nov dan, tudi na coFinder-ju.',
  ...
  'Create or take part in a project.' => 'Ustvari ali postani del ekipe ki uresničuje projekt.',
  ...
  'Getting content length is not supported.' => ''?????????????? Na kaj se pa to navezuje,
  ...
  'I have read and agree to the following Terms of Use {tos}' => 'Prebral sem in se strinjam s Pogoji uporabe {tos}'!!!!!!! Tukaj bo verjetno drug link ker gre za slo verzijo tos,
  ...
  'Login' => 'Prijava',
  'Login now' => 'Prijavite se!',
  'Message can\'t be empty!' => 'Sporočilo ne sme biti prazno!',
  'Minimal password length 4 characters.' => 'Najmanjša dolžina gesla so vsaj 4 znaki.',
  ...
  'Newsletter sent successfully.' => 'Uspešno poslan novičnik.',
  ...
  'On' => 'Vključeno',
  'Oops! Something went wrong. Unable to add new member to project.' => 'Oops! Nekaj je bilo narobe. Ni nam uspelo dodati novega člana k projektu.',
  'Oops! Something went wrong. Unable to remove member from project.' => 'Oops! Nekaj je bilo narobe. Ni nam uspelo odstraniti člana od projekta.',
  'Oops! This project does not exist.' => 'Oops! Ta projekt ne obstaja.',
  'Password is incorrect.' => 'Nepravilno geslo.',
  'Password recovery for coFinder' => 'Obnovitev gesla za coFinder',
  'To activate your account, please go to {activation_url}' => 'Za aktivacijo vašega računa, prosim kliknite na {activation_url}',
  ...
  'Please enter the letters as they are shown in the image above.
		<br/>Letters are not case-sensitive.' => 'Prosimo vtipkajte črke, kot so prikazane v gornji sliki.<br/>Črke niso občutljive na velikost.'!!!!!!!!!!!!!!!! Skoraj isto kot predhodni,
