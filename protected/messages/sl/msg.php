...
return array (
  ...
  'At the end, we will append a link like this <strong>{url}</strong> to your project.' => 'Na konec vam bomo pripeli takšno povezavo na vaš projekt <strong>{url}</strong>',
