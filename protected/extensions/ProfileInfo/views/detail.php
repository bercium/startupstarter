<div class="sidebar profile-info  edit-content radius panel s-ide">
  <a class="button radius small right secondary" trk="profile_details" href="<?php echo Yii::app()->createUrl("profile/completeness"); ?>" ><?php echo Yii::t('app', 'Details'); ?></a>
  
  <h4 style="margin-top:8px;margin-bottom:12px;"><?php echo Yii::t('app',"Profile completeness"); ?>
  </h4>
  <a href="<?php echo Yii::app()->createUrl("profile/completeness"); ?>" trk="profile_details_progress">
  ...
  <?php if ($invites > 0) { ?>
    <a class="button radius small-12" href="#" trk="profile_invite" data-dropdown="drop-invitation-msg"><?php echo Yii::t('app', 'Send invitation ({n})', array($invites)); ?></a>
  <?php } ?>
