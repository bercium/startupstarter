...
class m140213_182824_message_sent extends CDbMigration
{
    ...
    $this->execute("CREATE TABLE IF NOT EXISTS `mail_click_log` (
      ...
      $this->execute("ALTER TABLE `mail_click_log` ADD CONSTRAINT `mail_click_log_ibfk_1` FOREIGN KEY (`mail_tracking_code`) REFERENCES `mail_log` (`tracking_code`) ON DELETE CASCADE ON UPDATE CASCADE;");
